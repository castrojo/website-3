...
- Maintenance reference: docs/wolves-maintenance.md. Agents edit content only;
  this component's markup, styles, and logic are locked design.
...
- Lore records: Markdown files in `src/data/lore/` parsed by
  `src/data/wolves-lore-records.ts` and scheduled by `src/data/wolves-narrative-timeline.ts`.
...
- Track registry: `public/wolves-playlist.json`, regenerated by `npm run update:wolves-playlist`.
-->
