...
- **Natali Vlatko's title reads "Some build walls to protect — I build walls shatter."** Keep this exact authored text and the existing `position: 'right'` / `raised: true` cue behavior.
