...
30. **Master Playhead Narrative Drive:** The soundtrack master playhead (Track 0) drives the active page number (1 to 20) exactly, mapping to precise hardcoded timeline segments. This prevents micro-gaps, skipping, or repeats. Every page and quote is presented exactly once chronologically, like pages in a book, with no dynamic auto-rotation or shuffling.
