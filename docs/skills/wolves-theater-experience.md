...
30. **Decoupled Chronological Lore Rotation:** The active lore transmission or quote must rotate sequentially in chronological order via its native timers rather than being locked to individual pages of the comic reader. Unifying or syncing progress continuously via a master timeline causes fragile resets, loops, and repeats. Instead, keep the slideshow anchored securely on its starting pages (Page 1 for Track 0, Page 8 for Track 1, and Page 15 for Track 6), and let each unique lore entry display exactly once per chapter, halting and locking in place when the final story quote is reached. This preserves the natural, chronological flow of pages in a book without shuffling.
